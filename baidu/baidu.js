try {
	window._ssp_global = window._ssp_global || {}, function(t) {
		var e = {
			global: t,
			proxyName: !1,
		...
		function() {
			var i = {
				...
				deepClone: function(t, e) {
					...
					var i, n = e - 1;
					if (e > 0) if (t instanceof Date) i = new Date, i.setTime(t.getTime());
				...
				define: function(t) {
					...
					for (var n, o = !1, r = !1, s = i.split("."), a = s.length, d = this.classes, l = 0; a > l; l++) n = s[l], n && (d[n] = d[n] || {}, d = d[n]);
					d[e] = d[e] || {};
					var c = d;
	...
	}(_ssp_global), function(t) {
		var e = +new Date;
		t.setPath("https://dup.baidustatic.com/"), t.define({
			name: "static",
			...
			IS_CNAME: !1,
			$config: function() {
				this.HTTP_PROTOCOL = "https:" === location.protocol ? "https:" : "http:", t.global.userConfig && t.global.userConfig.domain && (this.REQUEST_URL_CNAME = t.global.userConfig.domain || "")
			}
		}), t.define({
			name: "lang",
			...
			checkBrowser: function() {
				var t = navigator.userAgent,
					e = window.RegExp;
				/msie (\d+\.\d)/i.test(t) && (this.ie = document.documentMode || +e.$1), /opera\/(\d+\.\d)/i.test(t) && (this.opera = +e.$1), /firefox\/(\d+\.\d)/i.test(t) && (this.firefox = +e.$1), /(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(t) && !/chrome/i.test(t) && (this.safari = +(e.$1 || e.$2)), /chrome\/(\d+\.\d)/i.test(t) && (this.chrome = +e.$1, this.test360() && (this.qihoo = !0)), /qqbrowser\/(\d+\.\d)/i.test(t) && (this.tencent = !0), (/ucbrowser\/(\d+\.\d)/i.test(t) || /ubrowser\/(\d+\.\d)/i.test(t)) && (this.uc = !0);
				try {
			...
			load: function(e, i, n) {
				...
				if (!r) {
					...
					d.parentNode.insertBefore(s, d), this.loadingCls[e] = n
				}
			},
			check: function() {
			...
			domainProto: function(t) {
				...
				if (t && "string" == typeof t) {
					...
					return "/" !== n && (i += "/"), e = i.replace("http:", "").replace("https:", ""), e.indexOf("//") < 0 && (e = "//" + e), e
				}
			},
			...
			queryToJson: function(t) {
				for (var e, i, n, o, r = t.substr(t.indexOf("?") + 1), s = r.split("&"), a = s.length, d = {}, l = 0; a > l; l++) o = s[l].split("="), e = o[0], i = o[1], n = d[e], "undefined" == typeof n ? d[e] = i : "[object Array]" == Object.prototype.toString.call(n) ? n.push(i) : d[e] = [n, i];
				return d
			},
			...
			paramsList: [{
				...
				limit: 700,
				value: function() {
					if (this.slotInfo.rpdn && 0 !== location.protocol.indexOf("http")) return this.config.HTTP_PROTOCOL + "//" + this.slotInfo.rpdn;
			...
			$sceneTactics: function() {
				...
				this.config.REQUEST_URL_CNAME && this.replaceDomain(), this.config.POS_URL = this.config.HTTP_PROTOCOL + this.config.REQUEST_URL + this.QueryURI[0] + "c" + this.QueryURI[1] + "m?", this.config.EXP_SWITCH && this.exp.tactics()
			},
			sceneTactics: function() {},
			...
			validate: function(t, e, i, n, o) {
				...
				return !d && l ? r = parseInt(a.imgWidth, 10) === parseInt(t, 10) && parseInt(a.imgHeight, 10) === parseInt(e, 10) : d && c && this.isAvalibleTextSize(t, e) && (r = !0), r
			},
			...
			render: function(e) {
				...
				this.alreadyEnableHidden = !0, this.autoCloseTime = e.response.placement.container.closeTime || 5, e.styleOpenApi.cpro_close_time && (this.autoCloseTime = parseInt(e.styleOpenApi.cpro_close_time, 10) || 5), this.autoCloseTime = this.autoCloseTime >= 3 ? this.autoCloseTime : 3;
			...
			snap: function(t) {
				for (var e = [], i = t.paramsList, n = 0, o = i.length; o > n; n++) {
					...
					try {
						...
						h += "?type=adcodex_error", h += "&info=" + encodeURIComponent(c.message), h += "&stack=" + encodeURIComponent(c.stack || ""), h += "&key=" + encodeURIComponent(s), h += "&t=" + (new Date).getTime(), (new Image).src = h
					}
				}
				return e
			},
			processExtendsParam: function(t) {
				...
				if (s && s.hasOwnProperty("sspw") && s.hasOwnProperty("ssph")) {
					...
					if (a && d && (i.width = a, i.height = d), l > 0 && (i.sizeType = l), 1 === l) t.width = a, t.height = d;
					else if (2 === l) {
			...
			getParamObj: function(t) {
				var e = [];
				this.slotParams.setSlotInfo(t), this.browserParams.setSlotInfo(t), e = e.concat(this.snap(this.slotParams)), e = e.concat(this.snap(this.businessParams)), e = e.concat(this.snap(this.browserParams)), e = e.concat(this.snap(this.additionalParam)), e = e.concat(this.snap(this.systemParams));
			...
			getPmpRequestUrl: function(t) {
				...
				if (l) {
					...
					var c = t.width,
						h = t.height;
					c > 0 && h > 0 && (e.sz && (e.sz = ""), i.push("sz=" + c + "x" + h)), t.pcwd && i.push("conwid=" + c), t.pchd && i.push("conhei=" + h);
					var u = l.pdb_deliv;
					u.deliv_id && i.push("pdbid=" + u.deliv_id), l.media_protect && i.push("mpdi=" + l.media_protect);
					var p = l.order_deliv;
					...
					if (t.isNeedCacheRequest || 4 === f || 7 === f) {
						var g = e.qn;
						e.dpv = g, t.paramObj.dpv = g, this.requestCache.add(g, t)
					}
					i.push("dc=2"), r && s > 0 && (e.tt = s + "." + (a - s) + "." + (d - s) + "." + (+new Date - s)), e.exps && (i.push("exps=" + e.exps), e.exps = "")
				}
				var y = i.join("&");
			...
			setStatus: function(t, e) {
				...
				i && (i.status |= e), (e & this.config.STATUS_CREATE) > 0 && (this.storageTime[t] = +new Date), (e & this.config.STATUS_FINISH) > 0 && this.adSlotFinish(t)
			},
			...
			requestSlotInfo: function(t) {
				var e = !1;
				t.paramObj = this.param.getParamObj(t), t.paramObj.exps = this.config.EXP_ID, t.paramObj.pcn = this.config.IS_CNAME ? this.config.REQUEST_URL_CNAME : "";
				...
				var o = !1;
				"union" === t.productLine && (o = !0), t.isAsync === !0 && (o = !0), e = this.localAdInfo(t), e ? (this.setStatus(t.id, this.config.STATUS_REQUEST), window[this.config.LOADER_DEFINE_NAME](e)) : (this.sendJsonpRequest(n, o), this.setStatus(t.id, this.config.STATUS_REQUEST))
			},
				...
				for (var t, e = 0, i = this.delieveryObjArray.length; i > e; e++) {
					...
					if (n.hasOwnProperty("id")) {
						...
						if (n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync : n.hasOwnProperty("async") && n.async && (o = n.async), t = this.slot.createSlot({
							...
							productLine: "adcodex",
							isAsync: o
						}), this.additionalParam.paramCheck(t, n), t.containerId = n.container || t.containerId, t.display = n.display, t.rpdn = n.rpdn || "", t.ftpc = n.ftpc || !1, t.size = n.size || "", t.pcwd = n.pcwd || "", t.pchd = n.pchd || "", !t.styleOpenApi.cpro_w && !t.styleOpenApi.cpro_h) {
							var r, s = n.size;
							if (s && s.indexOf(":") > -1) {
								r = s.split(":");
			...
			processFrameData: function(e) {
				...
				var m = {};
				return m.iframeId = e.iframeId, m.srcAttriName = "src", m.onloadDefine = o, m.iframeWidth = "" + d, m.iframeHeight = "" + l, m.url = i, m
			},
			...
			render: function(t, e) {
				...
				if (!t.isAsync && !r) return document.write(s), this.slot.setStatus(t.id, this.config.STATUS_FINISH), !0;
			...
			createContainerElementByInfo: function(t) {
				...
				if (1 === t.followType) {
					...
					i.push(o.cssName + ":" + o.cssValue + "px;"), i.push(r.cssName + ":" + r.cssValue + "px;")
				} else {
			...
			processSlotInfo: function(t) {
				...
				if (1 === o) e.width = r, e.height = s;
					...
					n.width = t.width = e.width = p, n.height = t.height = e.height = s
				}
				e.sizeType = o;
				var m = t.styleOpenApi,
					f = m.cpro_w || m.rsi0 || 0,
					g = m.cpro_h || m.rsi1 || 0;
				return (f || g) && (e.width = f || this.getCurViewportWidth(r), e.height = g || s, t.width = e.width, t.height = e.height), e
			},
			...
			parseCloseBtnLayoutData: function(t) {
				...
				var a = {
					...
					closeBtnWidth: "" + e,
					closeBtnHeight: i,
					closeBtnImgUrl: "https://cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.0/xuantingClose" + o + ".png"
				};
				return a
			},
				...
				if (this.validate(i)) {
					...
					if (!n) {
						...
						if (o) {
							...
							document.body.insertBefore(o, document.body.firstChild), o.innerHTML = l;
							var c = this.dom.g(e.containerId + "_closebtn");
							c && this.dom.bind(c, "click", t.proxy(this, this.closeBtnOnClickHandler, e)), this.hiddenFloatAd.render(e), e.isPdbAd || this.slot.setStatus(e.id, this.config.STATUS_FINISH)
						}
					}
				}
			}
				...
				if (this.validate(e)) {
					...
					if (!i) {
						...
						if (6 === s) {
							...
							a.response.placement.container.location = 5, a.containerId = a.containerId + "_right", this.slot.addSlot(a), n.push(a), d.response.placement.container.location = 4, d.containerId = d.containerId + "_left", this.slot.addSlot(d), n.push(d)
						}
			...
			process: function() {
				this.prepareApi(), this.unionDelivery.launch(), this.dupDelivery.launch(), this.clbDelivery.launch(), this.standardDelivery.launch(), this.fingerPrint.start()
			},
			prepareApi: function() {
			...
			callback: function(e) {
				try {
					...
					i.response = e, this.slot.setStatus(i.id, this.config.STATUS_RESPONSE), this.slot.processSlot(i), i.timestampWatcher.t3 = (new Date).getTime(), this.param.processExtendsParam(i);
					var n = this.painterSelector.getPainter(i),
						o = t.using(n);
					o ? o.render(i) : n && this.loader.load(i.id, n, t.proxy(this, this.painterLoadedCallback, n, i)), setTimeout(t.proxy(this.slot, this.slot.adInfoStorage, i), 3e3)
				} catch (r) {
