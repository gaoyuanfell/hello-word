    ...
    window._ssp_global = window._ssp_global || {},
        function (ass) {
            var e = {
                global: ass,
                proxyName: !1,
                basePath: "//cpro.baidustatic.com/cpro/ui/dup/"
            };
            !function () {
                ...
                var i = {
                    ...
                    proxy: function (t, e) {
                        ...
                        var n = i.shift();
                        var o = "function" == typeof this ? this : i.shift();
                        return function () {
                    ...
                    define: function (t) {
                        ...
                        t.__name = e,
                            ...
                            t.__constructor = function (t, e, i, n, o) {
                                if (this.__clones && this.__clones.length > 0) for (var r = 0, s = this.__clones.length; s > r; r++) {
                        ...
                        for (var n, o = i.split("."), r = o.length, s = this.classes, a = 0; r > a; a++) n = o[a],
                        n && (s[n] = s[n] || {}, s = s[n]);
                        s[e] = s[e] || {};
                        var d = s;
                        if (s = s[e], !s.__name || !s.__registed) {
                            t.__registed = !0,
                                d[e] = t;
                                t = d[e];
                            var l = this.loadDeps(t);
                            if (l.length > 0) {
                                if (this.loader = this.loader || this.using("oojs.loader"), "browser" !== this.runtime || !this.loader) throw new Error('class "' + t.name + '" loadDeps error:' + l.join(","));
                                this.loader.loadDepsBrowser(t, l)
                            } else {
                                t.__static()
                            }
                        }
        ...
        function (t) {
            var e = +new Date;
            t.setPath("//dup.baidustatic.com/"),
                t.define({
                    name: "static",
                    namespace: "dup.ui.assertion.dan",
                    deps: {"static":'dup.ui.assertion.dan.static'},
                    painterName: "static",
                    assert: function (t) {
                        var e = t.pdb_deliv,
                            i = e.deliv_des;
                ...
                t.define({
                    ...
                    assert: function (t) {
                        var e = t.placement,
                            i = e.container,
                            n = e.fillstyle;
                        return !(3 != i.anchoredType || !i.slide || 8 != n.btnStyleId)
                    }
                }),
                t.define({
                ...
                t.define({
                    ...
                    assert: function (t) {
                        var e = t.placement,
                            i = e.container,
                            n = e.fillstyle;
                        return !!(10 == i.anchoredType && i.slide && n.btnStyleId <= 7)
                    }
                }),
                t.define({
                    name: "baiduRec",
                ...
                t.define({
                    ...
                    IS_CNAME: !1,
                    $config: function () {
                        this.HTTP_PROTOCOL = "https:" === location.protocol ? "https:" : "http:",
                        t.global.userConfig && t.global.userConfig.domain && (this.REQUEST_URL_CNAME = t.global.userConfig.domain || "")
                    }
                }),
                t.define({
                    name: "lang",
                ...
                t.define({
                    ...
                    ready: function (e, i, n) {
                        ...
                        var r = t.proxy(this, function () {
                                ...
                                } else if ("complete" === o.readyState || this.domContentLoaded) t = !0;
                ...
                t.define({
                    ...
                    domainProto: function (t) {
                        var e;
                        if (t && "string" == typeof t) {
                            var i = t.toString() || "";
                            if (!i) return "";
                            var n = i.substring(i.length - 1);
                            return "/" !== n && (i += "/"),
                                e = i.replace("http:", "").replace("https:", ""),
                            e.indexOf("//") < 0 && (e = "//" + e),
                                e
                        }
                    },
                    ...
                    queryToJson: function (t) {
                        for (var e, i, n, o, r = t.substr(t.indexOf("?") + 1), s = r.split("&"), a = s.length, d = {}, l = 0; a > l; l++) o = s[l].split("="),
                            e = o[0],
                            i = o[1],
                            n = d[e],
                    ...
                    getQueryURI: function (t) {
                        for (var e = [], i = 0; t > i; i++) {
                            var n = String.fromCharCode(Math.floor(26 * Math.random()) + "a".charCodeAt(0)),
                                o = /^[a-z]+$/g;
                            o.test(n) && e.push(n)
                        }
                        return e
                ...
                t.define({
                    ...
                    start: function () {
                        ...
                        var id = this.dom.g(this.fpElId);
                        id || this.event.bind(window, "load", t.proxy(this, this.createFPIframe))
                    },
                    createFPIframe: function () {
                        if (!this.dom.g(this.fpElId)) {
                            ...
                            var a = "//pos.baidu.com/wh/o.htm?ltr=",
                ...
                t.define({
                    ...
                    assert: function (t) {
                        ...
                        return l.indexOf("mobile") >= 0 ? c > 0 || this.mobile.assert(t.response) ? "mobile.float" : "mobile.inlayFix" : "template_float_searchBar" === l ? "searchBar" : "template_float_bottom_lu" === l ? "slide" : l.indexOf("_xuanfu") >= 0 || l.indexOf("float") >= 0 ? "float" : c > 0 || this.dynamicFloat.assert(t.response) ? "dynamicFloat" : l && l.length > 0 ? "inlayFix" : ""
                    }
                }),
                t.define({
                    name: "sceneTactics",
                    ...
                    $sceneTactics: function () {
                        this.QueryURI = this.url.getQueryURI(2),
                        this.config.REQUEST_URL_CNAME && this.replaceDomain(),
                            this.config.POS_URL = this.config.HTTP_PROTOCOL + this.config.REQUEST_URL + this.QueryURI[0] + "c" + this.QueryURI[1] + "m?",
                        this.config.EXP_SWITCH && this.exp.tactics()
                    },
                    scene: function () {
                    },
                    replaceDomain: function () {
                        (this.browser.uc || this.browser.tencent) && (this.config.REQUEST_URL = this.url.domainProto(this.config.REQUEST_URL_CNAME), this.config.IS_CNAME = !0)
                    }
                }),
                t.define({
                    ...
                    validate: function (t, e, i, n, o) {
                        ...
                        if (!s) return r;
                        for (var a = this.parsePreviewData(s), d = 1 === parseInt(a.type, 10), l = !(n.length > 0), c = !(n.length > 0), h = 0, u = n.length; u > h; h++) {
                            var p = n[h];
                ...
                t.define({
                    ...
                    render: function (e) {
                        ...
                        this.alreadyEnableHidden = !0,
                            this.autoCloseTime = e.response.placement.container.closeTime || 5,
                        e.styleOpenApi.cpro_close_time && (this.autoCloseTime = parseInt(e.styleOpenApi.cpro_close_time, 10) || 5),
                        ...
                        this.dockTo = parseInt(o.location, 10) || this.BOTTOM,
                            ...
                            this.adIframe = this.dom.g(e.containerId + "_frame");
                ...
                t.define({
                    ...
                    getPainter: function (e) {
                        ...
                        return i || (e.errors = e.errors || [], e.errors.push("painterName is empty")),
                            "dup.ui.painter.inlayFix"
                    }
                }),
                t.define({
                    name: "businessParam",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                return i = t(window) ? window.top : window,
                                    e = i.BAIDU_DUP2_pageFirstRequestTime,
                                    e ? o - e >= n && (e = i.BAIDU_DUP2_pageFirstRequestTime = o) : e = i.BAIDU_DUP2_pageFirstRequestTime = o,
                                e || ""
                            }
                        },
                        {
                ...
                t.define({
                    ...
                    snap: function (t) {
                        for (var e = [], i = t.paramsList, n = 0, o = i.length; o > n; n++) {
                            ...
                            try {
                                ...
                                c += "?type=adcodex_error",
                                    c += "&info=" + encodeURIComponent(l.message),
                                    c += "&stack=" + encodeURIComponent(l.stack || ""),
                                    c += "&key=" + encodeURIComponent(s),
                                    c += "&t=" + +new Date,
                                    (new Image).src = c
                            }
                        }
                    ...
                    getPmpRequestUrl: function (t) {
                        ...
                        if (l) {
                            ...
                            var p = l.order_deliv;
                            p.deliv_id && i.push("orderid=" + p.deliv_id),
                            p.demand_id && i.push("odid=" + p.demand_id);
                            var m = l.rtb_deliv;
                            m.deliv_id && i.push("rtbid=" + m.deliv_id),
                            m.demand_id && i.push("rdid=" + m.demand_id);
                            var f = l.placement.complement_type;
                            if (t.isNeedCacheRequest || 4 === f || 7 === f) {
                                var g = e.qn;
                                e.dpv = g,
                                    t.paramObj.dpv = g,
                                    this.requestCache.add(g, t)
                            }
                            i.push("dc=2"),
                            r && s > 0 && (e.tt = s + "." + (a - s) + "." + (d - s) + "." + (+new Date - s)),
                            e.exps && (i.push("exps=" + e.exps), e.exps = "")
                        }
                        var y = i.join("&");
                        return this.config.POS_URL + y + "&" + this.getParamString(e)
                    }
                }),
                t.define({
                    name: "slot",
                    ...
                    createSlot: function (t) {
                        ...
                        var n = {};
                        return n.index = this.slotIdCountMap[i]++,
                            n.count = ++this.slotCount,
                            n.id = i + "_" + n.index,
                            n.containerId = this.config.DUP_PREFIX + "_wrapper_" + i + "_" + n.index,
                            n.slotId = t.slotId,
                            n.productLine = t.productLine,
                            n.errors = [],
                            n.isAsync = t.isAsync,
                            this.setStatus(n.id, this.config.STATUS_CREATE),
                            e ? n.timestampWatcher = {
                                t1: e
                            } : n.timestampWatcher = {
                                t1: 0
                            },
                            window.cproStyleApi ? n.styleOpenApi = window.cproStyleApi[i] || {} : n.styleOpenApi = {},
                        0 === i.indexOf("u") && (n.productLine = "union", n.width = n.styleOpenApi.cpro_w || n.styleOpenApi.rsi0 || 0, n.height = n.styleOpenApi.cpro_h || n.styleOpenApi.rsi1 || 0),
                            n
                    },
                    ...
                    processSlot: function (t) {
                        ...
                        if (t.response) {
                            var n = t.response.rtb_deliv,
                                ...
                                d = parseInt(o.demand_id, 10);
                            e = !(r || s || a || d),
                            (e || 0 !== a) && (i = 0 !== r || 0 !== a)
                        }
                        t.isPdbAd = e,
                            t.isNeedCacheRequest = i
                    },
                    addSlot: function (t) {
                    ...
                    //TODO 11 创建容器 //var i = {};i.status |= 1 ;Object {status: 1}
                    setStatus: function (t, e) {
                        var i = this.getSlotInfo(t);
                        if (i && (i.status |= e), (e & this.config.STATUS_CREATE) > 0 && (this.storageTime[t] = +new Date), (e & this.config.STATUS_FINISH) > 0) {
                            var n = (new Date).getTime() - this.storageTime[t],
                                o = {
                                    type: "performance",
                                    id: t,
                                    mes: n,
                    ...
                    requestSlotInfo: function (t) {
                        ...
                        t.paramObj = this.param.getParamObj(t),
                            t.paramObj.exps = this.config.EXP_ID,
                            t.paramObj.pcn = this.config.IS_CNAME ? this.config.REQUEST_URL_CNAME : "";
                        var i = this.param.getParamString(t.paramObj),
                            n = this.config.POS_URL + i;
                        t.paramObj.dtm = this.config.HTML_POST,
                            t.timestampWatcher.t2 = +new Date;
                        var o = !1;
                        "union" === t.productLine && (o = !0),
                        t.isAsync === !0 && (o = !0),
                        this.config.EXP_SATUS && (e = this.localAdInfo(t)),
                            e ? (this.setStatus(t.id, this.config.STATUS_REQUEST), window[this.config.LOADER_DEFINE_NAME](e)) : (this.sendJsonpRequest(n, o), this.setStatus(t.id, this.config.STATUS_REQUEST))
                    },
                    localAdInfo: function (t) {
                        try {
                            var e = {};
                            if (!this.storage.isAvailable) return !1;
                            if (this.storageSlotInfo = this.storage.getItem(t.id), !this.storageSlotInfo) return !1;
                            if (e = this.lang.jsonToObj(this.storageSlotInfo), !e || !e.adExpire) return !1;
                            var i = (new Date).getTime(),
                                n = i - e.adExpire;
                            return n > this.config.STORAGE_TIMER ? (this.storage.removeItem(t.id), !1) : e
                        } catch (o) {
                    ...
                    createContainer: function (t) {
                        if (!(t.status > this.config.STATUS_CREATE)) {
                            ...
                            t.isAsync ? "union" === t.productLine && (t.containerId = "cpro_" + t.slotId) : (document.write('<div id="' + t.containerId + '"></div>'), this.dom.g(t.containerId) || this.createBackupWrapper(t)),
                ...
                t.define({
                    ...
                    updateViewStatus: function (t, e, i) {
                        ...
                        this.intervalStatus === this.STATUS.LOAD && (this.intervalStatus = this.STATUS.RUN, n = o = 0, r = o = 0),
                            t.currViewStatus ? (this.intervalStatus === this.STATUS.LOAD && (n = parseInt(s.getTime() - t.inViewTimeStamp.getTime(), 10), 0 > n ? n = 0 : n > this.intervalTimeSpan && (n = this.intervalTimeSpan)), t.inViewTime += n, t.inViewTimeStamp = s) : e && (t.inViewTimeStamp = s),
                            t.currViewStatus = e,
                            t.currAdViewStatus ? (this.intervalStatus === this.STATUS.UNLOAD && (r = parseInt(s.getTime() - t.adViewTimeStamp.getTime(), 10), 0 > r ? r = 0 : r > this.intervalTimeSpan && (r = this.intervalTimeSpan)), t.adViewTime += r, t.adViewTimeStamp = s) : i && (t.adViewTimeStamp = s),
                            t.currAdViewStatus = i,
                            t.pageStayTime = t.pageStayTime || 0,
                            this.pageStayTime = this.pageStayTime || 0,
                        this.intervalStatus === this.STATUS.UNLOAD && (this.pageTimeSpan = parseInt(s.getTime() - t.pageStayTimeStamp.getTime(), 10), 0 > o ? o = 0 : o > this.intervalTimeSpan && (o = this.intervalTimeSpan)),
                            t.pageStayTime += o,
                            this.pageStayTime += o,
                        this.winFocused && (t.focusTime += o),
                            t.pageStayTimeStamp = s,
                            t
                    },
                    computeViewStatus: function (t) {
                        ...
                        if (this.winFocused) try {
                            var r = this.style.getClientWidth(this.win),
                                ...
                                d = this.style.getOuterWidth(i),
                                l = this.style.getOuterHeight(i);
                ...
                t.define({
                    ...
                    launch: function () {
                        ...
                        e && (t = this.slot.createSlot({
                            ...
                            productLine: "union",
                            isAsync: !1
                        }), console.info(t),this.slot.addSlot(t));
                        ...
                        if (window.cpro_mobile_slot = null, r) for (var n = 0, o = r.length; o > n; n++) {
                            var s = r[n];
                        ...
                        for (var t, e = 0, i = this.delieveryObjArray.length; i > e; e++) {
                            ...
                            if (n.hasOwnProperty("id")) {
                                ...
                                if (n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync : n.hasOwnProperty("async") && n.async && (o = n.async), t = this.slot.createSlot({
                                        ...
                                        productLine: "adcodex",
                                        isAsync: o
                                    }), this.additionalParam.paramCheck(t, n), t.containerId = n.container || t.containerId, t.display = n.display, t.ftpc = n.ftpc || !1, t.size = n.size || "", t.pcwd = n.pcwd || "", t.pchd = n.pchd || "", !t.styleOpenApi.cpro_w && !t.styleOpenApi.cpro_h) {
                                    var r, s = n.size;
                                    if (s && s.indexOf(":") > -1) {
                                        r = s.split(":");
                ...
                t.define({
                    ...
                    processFrameData: function (e) {
                        ...
                        var d = e.width || n && n.width,
                            l = e.height || n && n.height,
                            c = this.creativePreview.getPreviewUrl(d, l, r, e.displayType || "inlay");
                        if (c) i = c;
                        else if (e.isPdbAd) {
                            var h = this.config.DUP_PREFIX + "renderFrame";
                            this.data.defineOnce(h, t.proxy(this, this.renderFrame)),
                                i = this.getFrameUrl(),
                                o = 'onload="' + h + "('" + e.id + "', this);\""
                        } else if (e.isNeedCacheRequest) {
                            var u = this.config.DUP_PREFIX + "cacheRequest",
                                p = "adsbybaidu_callback";
                            this.data.defineOnce(p, t.proxy(this, this.cacheRequestCallback)),
                                this.data.defineOnce(u, t.proxy(this.requestCache, this.requestCache.cacheRequest)),
                                i = this.param.getPmpRequestUrl(e),
                                o = 'onload="' + u + "('" + e.paramObj.dpv + "', this);\""
                        } else i = this.param.getPmpRequestUrl(e);
                        var m = {};
                        return m.iframeId = e.iframeId,
                            m.srcAttriName = "src",
                            m.onloadDefine = o,
                            m.iframeWidth = "" + d,
                            m.iframeHeight = "" + l,
                ...
                t.define({
                    ...
                    createCloseElement: function (t) {
                        ...
                        return e.couplet = function () {
                            ...
                            e["default"] = function () {
                                var e = "//cpro.baidustatic.com/cpro/ui/noexpire/img/clb/1.0.0/close.gif",
                    ...
                    closeBtnOnMouseOverHandler: function () {
                        ...
                        if (e) if ("couplet" === this.info.blockType) e.style.backgroundColor = "#0066cc";
                            ...
                            n.style.backgroundImage = "url(//cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.0/xuanfu_mouseover_close.png)"
                        }
                    },
                    closeBtnOnMouseOutHandler: function () {
                        ...
                        if (e) if ("couplet" === this.info.blockType) e.style.backgroundColor = "#999999";
                            ...
                            var n = e.getElementsByTagName("a")[0];
                            n.style.backgroundImage = "url(//cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.1/xuanfu_close.png)"
                        }
                    },
                    autoClose: function () {
                    ...
                    render: function (e, i) {
                        if (this.validate(e)) {
                            ...
                            this.dom.g(e.domId) || document.body.insertBefore(s, document.body.firstChild),
                                this.registEvent(e);
                            var a = e.closeTime || 0;
                            a > 0 && setTimeout(t.proxy(this, this.autoClose), 1e3 * a),
                            i.isPdbAd || this.slot.setStatus(i.id, this.config.STATUS_FINISH)
                        }
                    }
                }),
                t.define({
                    ...
                    processSlotInfo: function (t) {
                        ...
                        if (1 === o) e.width = r,
                            ...
                            t.pcwd || t.ftpc ? (e.wScale = t.pcwd || "-1", t.styleOpenApi.cpro_ftpc = "true") : e.wScale = r,
                                t.pchd ? e.hScale = t.pchd : e.hScale = s;
                            var l = {},
                                c = t.styleOpenApi.cpro_ftpc || "true" === t.styleOpenApi.cpro_ftpc || "-1" === e.wScale;
                            c = 5 === o ? !0 : c;
                            var h = this.dom.g(t.containerId);
                            c && h && h.parentElement.clientWidth && (l.width = h.parentElement.clientWidth || 0),
                            "-1" === e.hScale && h && h.parentElement && (l.height = h.parentElement.clientHeight || 0);
                            var u = this.param.translateScaleToPixelSize(e.wScale, e.hScale, l);
                            n.width = u.width,
                                n.height = u.height,
                                t.width = u.width,
                                t.height = u.height,
                            ...
                            var p = this.getCurViewportWidth(r);
                            n.width = t.width = e.width = p,
                                n.height = t.height = e.height = s
                        }
                        e.sizeType = o;
                        var m = t.styleOpenApi,
                            f = m.cpro_w || m.rsi0 || 0,
                            g = m.cpro_h || m.rsi1 || 0;
                        return (f || g) && (e.width = f || this.getCurViewportWidth(r), e.height = g || s, t.width = e.width, t.height = e.height),
                            e
                    },
                ...
                t.define({
                    ...
                    parseCloseBtnLayoutData: function (t) {
                        ...
                        var a = {
                            ...
                            closeBtnWidth: "" + e,
                            closeBtnHeight: i,
                            closeBtnImgUrl: "//cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.0/xuantingClose" + o + ".png"
                        };
                        return a
                    },
                    ...
                    validate: function (t) {
                        ...
                        return 2 !== t.closeType || !i
                    },
                    render: function (e) {
                        if (!this.slot.adInfoIsAvailable(e)) return !1;
                        this.slot.setStatus(e.id, this.config.STATUS_RENDERED),
                            this.id = e.id,
                            e.displayType = "inlay-mobile";
                        ...
                        if (this.validate(i)) {
                            ...
                            if (!n) {
                                ...
                                if (o) {
                                    ...
                                    c && this.dom.bind(c, "click", t.proxy(this, this.closeBtnOnClickHandler, e)),
                                        this.hiddenFloatAd.render(e),
                ...
                t.define({
                    ...
                    updateApi: function () {
                        try {
                            this.data.defineOnce("BAIDU_CLB_prepareMoveSlot", t.proxy(this, this.prepareMove)),
                                this.data.defineOnce("BAIDU_DUP_addSlotStatusCallback", t.proxy(this.origentation, this.origentation.addSlotStatusCallback)),
                                this.data.defineOnce(this.config.DUP_PREFIX + "renderFrame", t.proxy(this.frame, this.frame.renderFrame)),
                                this.data.defineOnce("BAIDU_CLB_setConfig", t.proxy(this.data, this.data.putConfig)),
                                this.data.defineOnce("BAIDU_CLB_addOrientation", t.proxy(this.origentation, this.origentation.addOrientation)),
                                this.data.defineOnce("BAIDU_CLB_addOrientationOnce", t.proxy(this.origentation, this.origentation.addOrientationOnce)),
                                this.data.defineOnce("BAIDU_CLB_setOrientationOnce", t.proxy(this.origentation, this.origentation.setOrientationOnce)),
                                this.data.defineOnce("BAIDU_CLB_addSlot", t.proxy(this, this.reSet)),
                                this.data.defineOnce("BAIDU_CLB_enableAllSlots", t.proxy(this, this.reSet)),
                                this.data.defineOnce("BAIDU_CLB_SETHTMLSLOT", t.proxy(this, this.reSet))
                        } catch (e) {
                        }
                    },
                ...
                t.define({
                    ...
                    processSlotInfo: function (t) {
                        var e = t.response.placement,
                            ...
                            g = m[f];
                        "default" !== g && (u += 2 * this.GAP + 1, p += 2 * this.GAP + 1),
                            p += "couplet" === g ? this.COUPLET_CLOSE_BTN_HEIGHT : "button" === g || "popup" === g ? this.COUPLET_CLOSE_BTN_HEIGHT + this.GAP : this.NORMAL_CLOSE_BTN_HEIGHT;
                        var y = i.location,
                            v = "",
                            w = "";
                        switch (y) {
                ...
                t.define({
                    ...
                    callback: function (e) {
                        ...
                        i.response = e;
                            ...
                            i.timestampWatcher.t3 = (new Date).getTime();
                        ...
                        o ? o.render(i) : n && this.loader.load(i.id, n, t.proxy(this, this.painterLoadedCallback, n, i)),
                            setTimeout(t.proxy(this.slot, this.slot.adInfoStorage, i), 3e3)
                    },
            ...
            //TODO 1
            var i = t.using("dup.ui.delivery.main");
            i.process()
        }(_ssp_global.oojs)
} catch (e) {
